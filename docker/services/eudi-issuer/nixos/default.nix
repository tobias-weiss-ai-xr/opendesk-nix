...
"""
eudi-issuer NixOS Container Image
Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "eudi-issuer";
    WorkingDir = "/var/lib/eudi-issuer";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service eudi-issuer ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "eudi-issuer-opendesk";
    "org.opencontainers.image.description" = "eudi-issuer latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "eudi-issuer";
