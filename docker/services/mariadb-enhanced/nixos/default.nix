...
# 
# mariadb-enhanced NixOS Container Image
# Version: latest
...
docks.mkImage {
  name = "mariadb-enhanced-opendesk";
  tag = "latest-nixos";
  ...
  containerConfig = {
    ...
    Volumes = {
      "/var/lib/mariadb-enhanced" = {};
      "/var/log/mariadb-enhanced" = {};
      "/etc/mariadb-enhanced" = {};
    };
    ...
    User = "mariadb-enhanced";
    WorkingDir = "/var/lib/mariadb-enhanced";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service mariadb-enhanced ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "mariadb-enhanced-opendesk";
    "org.opencontainers.image.description" = "mariadb-enhanced latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "mariadb-enhanced";
