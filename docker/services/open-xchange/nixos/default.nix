...
# 
# open-xchange NixOS Container Image
# Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "open-xchange";
    WorkingDir = "/var/lib/open-xchange";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service open-xchange ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "open-xchange-opendesk";
    "org.opencontainers.image.description" = "open-xchange latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "open-xchange";
