...
"""
opencloud NixOS Container Image
Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service opencloud ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "opencloud-opendesk";
    "org.opencontainers.image.description" = "opencloud latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "opencloud";
