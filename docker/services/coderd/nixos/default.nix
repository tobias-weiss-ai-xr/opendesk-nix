...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "coderd";
    WorkingDir = "/var/lib/coderd";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service coderd ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "coderd-opendesk";
    "org.opencontainers.image.description" = "coderd latest for openDesk Edu with NixOS";
