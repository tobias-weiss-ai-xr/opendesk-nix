...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "sogo5";
    WorkingDir = "/var/lib/sogo5";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service sogo5 ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "sogo5-opendesk";
    "org.opencontainers.image.description" = "sogo5 latest for openDesk Edu with NixOS";
