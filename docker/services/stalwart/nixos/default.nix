...
# 
# stalwart NixOS Container Image
# Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service stalwart ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "stalwart-opendesk";
    "org.opencontainers.image.description" = "stalwart latest for openDesk Edu with NixOS";
