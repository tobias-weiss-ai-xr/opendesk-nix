...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "n8n";
    WorkingDir = "/var/lib/n8n";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service n8n ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "n8n-opendesk";
    "org.opencontainers.image.description" = "n8n latest for openDesk Edu with NixOS";
