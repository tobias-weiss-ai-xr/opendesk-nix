...
# 
# memcached NixOS Container Image
# Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "memcached";
    WorkingDir = "/var/lib/memcached";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service memcached ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "memcached-opendesk";
    "org.opencontainers.image.description" = "memcached latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "memcached";
