...
# 
# monitoring NixOS Container Image
# Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "monitoring";
    WorkingDir = "/var/lib/monitoring";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service monitoring ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "monitoring-opendesk";
    "org.opencontainers.image.description" = "monitoring latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "monitoring";
