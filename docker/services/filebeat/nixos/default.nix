...
# 
# filebeat NixOS Container Image
# Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "filebeat";
    WorkingDir = "/var/lib/filebeat";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service filebeat ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "filebeat-opendesk";
    "org.opencontainers.image.description" = "filebeat latest for openDesk Edu with NixOS";
