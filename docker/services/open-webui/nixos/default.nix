...
# 
# open-webui NixOS Container Image
# Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "open-webui";
    WorkingDir = "/var/lib/open-webui";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service open-webui ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "open-webui-opendesk";
    "org.opencontainers.image.description" = "open-webui latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "open-webui";
