...
"""
cryptpad NixOS Container Image
Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "cryptpad";
    WorkingDir = "/var/lib/cryptpad";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service cryptpad ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "cryptpad-opendesk";
    "org.opencontainers.image.description" = "cryptpad latest for openDesk Edu with NixOS";
