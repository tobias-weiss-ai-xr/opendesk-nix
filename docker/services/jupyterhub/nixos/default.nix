...
# 
# jupyterhub NixOS Container Image
# Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "jupyterhub";
    WorkingDir = "/var/lib/jupyterhub";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service jupyterhub ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "jupyterhub-opendesk";
    "org.opencontainers.image.description" = "jupyterhub latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "jupyterhub";
