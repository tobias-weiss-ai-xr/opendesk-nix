...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "slidev";
    WorkingDir = "/var/lib/slidev";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service slidev ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "slidev-opendesk";
    "org.opencontainers.image.description" = "slidev latest for openDesk Edu with NixOS";
