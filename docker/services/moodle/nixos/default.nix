...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "moodle";
    WorkingDir = "/var/lib/moodle";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service moodle ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "moodle-opendesk";
    "org.opencontainers.image.description" = "moodle latest for openDesk Edu with NixOS";
