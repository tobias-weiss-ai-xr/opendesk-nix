...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "typo3";
    WorkingDir = "/var/lib/typo3";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service typo3 ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "typo3-opendesk";
    "org.opencontainers.image.description" = "typo3 latest for openDesk Edu with NixOS";
