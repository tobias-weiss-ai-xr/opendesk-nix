...
# 
# semester-provisioning NixOS Container Image
# Version: latest
...
docks.mkImage {
  name = "semester-provisioning-opendesk";
  tag = "latest-nixos";
  ...
  containerConfig = {
    ...
    Volumes = {
      "/var/lib/semester-provisioning" = {};
      "/var/log/semester-provisioning" = {};
      "/etc/semester-provisioning" = {};
    };
    ...
    User = "semester-provisioning";
    WorkingDir = "/var/lib/semester-provisioning";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service semester-provisioning ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "semester-provisioning-opendesk";
    "org.opencontainers.image.description" = "semester-provisioning latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "semester-provisioning";
