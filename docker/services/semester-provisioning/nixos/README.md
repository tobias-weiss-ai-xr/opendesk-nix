# semester-provisioning NixOS Container
...
### Build the container
cd opendesk-nix
nix build .#semester-provisioning-nixos

### Load into Docker
docker load < result

### Run the container
docker run -d --name semester-provisioning \
  -p 8080:8080 \
  semester-provisioning-opendesk:latest-nixos
