...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "notes";
    WorkingDir = "/var/lib/notes";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service notes ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "notes-opendesk";
    "org.opencontainers.image.description" = "notes latest for openDesk Edu with NixOS";
