...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "kasmvnc";
    WorkingDir = "/var/lib/kasmvnc";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service kasmvnc ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "kasmvnc-opendesk";
    "org.opencontainers.image.description" = "kasmvnc latest for openDesk Edu with NixOS";
