...
# 
# timescale NixOS Container Image
# Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "timescale";
    WorkingDir = "/var/lib/timescale";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service timescale ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "timescale-opendesk";
    "org.opencontainers.image.description" = "timescale latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "timescale";
