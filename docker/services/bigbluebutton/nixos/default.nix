...
# 
# bigbluebutton NixOS Container Image
# Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "bigbluebutton";
    WorkingDir = "/var/lib/bigbluebutton";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service bigbluebutton ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "bigbluebutton-opendesk";
    "org.opencontainers.image.description" = "bigbluebutton latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "bigbluebutton";
