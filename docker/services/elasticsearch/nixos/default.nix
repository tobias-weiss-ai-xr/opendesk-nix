...
# 
# elasticsearch NixOS Container Image
# Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "elasticsearch";
    WorkingDir = "/var/lib/elasticsearch";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service elasticsearch ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "elasticsearch-opendesk";
    "org.opencontainers.image.description" = "elasticsearch latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "elasticsearch";
