...
"""
promtail NixOS Container Image
Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "promtail";
    WorkingDir = "/var/lib/promtail";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service promtail ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "promtail-opendesk";
    "org.opencontainers.image.description" = "promtail latest for openDesk Edu with NixOS";
