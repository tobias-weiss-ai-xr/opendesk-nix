...
# 
# nextcloud NixOS Container Image
# Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service nextcloud ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "nextcloud-opendesk";
    "org.opencontainers.image.description" = "nextcloud latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "nextcloud";
