...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "dovecot";
    WorkingDir = "/var/lib/dovecot";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service dovecot ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "dovecot-opendesk";
    "org.opencontainers.image.description" = "dovecot latest for openDesk Edu with NixOS";
