...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "kibana";
    WorkingDir = "/var/lib/kibana";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service kibana ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "kibana-opendesk";
    "org.opencontainers.image.description" = "kibana latest for openDesk Edu with NixOS";
