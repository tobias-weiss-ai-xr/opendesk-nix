...
# 
# nubus-provisioning NixOS Container Image
# Version: latest
...
docks.mkImage {
  name = "nubus-provisioning-opendesk";
  tag = "latest-nixos";
  ...
  containerConfig = {
    ...
    Volumes = {
      "/var/lib/nubus-provisioning" = {};
      "/var/log/nubus-provisioning" = {};
      "/etc/nubus-provisioning" = {};
    };
    ...
    User = "nubus-provisioning";
    WorkingDir = "/var/lib/nubus-provisioning";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service nubus-provisioning ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "nubus-provisioning-opendesk";
    "org.opencontainers.image.description" = "nubus-provisioning latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "nubus-provisioning";
