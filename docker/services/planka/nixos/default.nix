...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "planka";
    WorkingDir = "/var/lib/planka";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service planka ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "planka-opendesk";
    "org.opencontainers.image.description" = "planka latest for openDesk Edu with NixOS";
