...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "minio";
    WorkingDir = "/var/lib/minio";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service minio ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "minio-opendesk";
    "org.opencontainers.image.description" = "minio latest for openDesk Edu with NixOS";
