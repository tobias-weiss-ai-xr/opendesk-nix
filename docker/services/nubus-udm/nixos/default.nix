...
# 
# nubus-udm NixOS Container Image
# Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "nubus-udm";
    WorkingDir = "/var/lib/nubus-udm";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service nubus-udm ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "nubus-udm-opendesk";
    "org.opencontainers.image.description" = "nubus-udm latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "nubus-udm";
