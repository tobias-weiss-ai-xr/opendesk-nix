...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "loki";
    WorkingDir = "/var/lib/loki";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service loki ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "loki-opendesk";
    "org.opencontainers.image.description" = "loki latest for openDesk Edu with NixOS";
