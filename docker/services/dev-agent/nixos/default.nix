...
# 
# dev-agent NixOS Container Image
# Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "dev-agent";
    WorkingDir = "/var/lib/dev-agent";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service dev-agent ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "dev-agent-opendesk";
    "org.opencontainers.image.description" = "dev-agent latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "dev-agent";
