...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "rstudio";
    WorkingDir = "/var/lib/rstudio";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service rstudio ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "rstudio-opendesk";
    "org.opencontainers.image.description" = "rstudio latest for openDesk Edu with NixOS";
