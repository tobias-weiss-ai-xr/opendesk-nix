...
# 
# ilias-full NixOS Container Image
# Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "ilias-full";
    WorkingDir = "/var/lib/ilias-full";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service ilias-full ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "ilias-full-opendesk";
    "org.opencontainers.image.description" = "ilias-full latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "ilias-full";
