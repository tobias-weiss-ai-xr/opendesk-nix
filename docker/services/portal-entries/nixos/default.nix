...
# 
# portal-entries NixOS Container Image
# Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    Volumes = {
      "/var/lib/portal-entries" = {};
      "/var/log/portal-entries" = {};
      "/etc/portal-entries" = {};
    };
    ...
    User = "portal-entries";
    WorkingDir = "/var/lib/portal-entries";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service portal-entries ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "portal-entries-opendesk";
    "org.opencontainers.image.description" = "portal-entries latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "portal-entries";
