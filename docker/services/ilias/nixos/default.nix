...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "ilias";
    WorkingDir = "/var/lib/ilias";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service ilias ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "ilias-opendesk";
    "org.opencontainers.image.description" = "ilias latest for openDesk Edu with NixOS";
