...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "argocd";
    WorkingDir = "/var/lib/argocd";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service argocd ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "argocd-opendesk";
    "org.opencontainers.image.description" = "argocd latest for openDesk Edu with NixOS";
