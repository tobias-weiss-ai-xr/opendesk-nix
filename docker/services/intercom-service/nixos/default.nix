...
"""
intercom-service NixOS Container Image
Version: latest
...
docks.mkImage {
  name = "intercom-service-opendesk";
  tag = "latest-nixos";
  ...
  containerConfig = {
    ...
    Volumes = {
      "/var/lib/intercom-service" = {};
      "/var/log/intercom-service" = {};
      "/etc/intercom-service" = {};
    };
    ...
    User = "intercom-service";
    WorkingDir = "/var/lib/intercom-service";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service intercom-service ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "intercom-service-opendesk";
    "org.opencontainers.image.description" = "intercom-service latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "intercom-service";
