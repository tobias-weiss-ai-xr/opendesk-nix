...
"""
nubus-portal NixOS Container Image
Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    Volumes = {
      "/var/lib/nubus-portal" = {};
      "/var/log/nubus-portal" = {};
      "/etc/nubus-portal" = {};
    };
    ...
    User = "nubus-portal";
    WorkingDir = "/var/lib/nubus-portal";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service nubus-portal ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "nubus-portal-opendesk";
    "org.opencontainers.image.description" = "nubus-portal latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "nubus-portal";
