...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "jitsi";
    WorkingDir = "/var/lib/jitsi";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service jitsi ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "jitsi-opendesk";
    "org.opencontainers.image.description" = "jitsi latest for openDesk Edu with NixOS";
