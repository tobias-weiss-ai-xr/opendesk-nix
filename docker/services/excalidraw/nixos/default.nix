...
# 
# excalidraw NixOS Container Image
# Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "excalidraw";
    WorkingDir = "/var/lib/excalidraw";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service excalidraw ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "excalidraw-opendesk";
    "org.opencontainers.image.description" = "excalidraw latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "excalidraw";
