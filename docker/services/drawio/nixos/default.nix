...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "drawio";
    WorkingDir = "/var/lib/drawio";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service drawio ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "drawio-opendesk";
    "org.opencontainers.image.description" = "drawio latest for openDesk Edu with NixOS";
