...
docks.mkImage {
  ...
  containerConfig = {
    ...
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service etherpad ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "etherpad-opendesk";
    "org.opencontainers.image.description" = "etherpad latest for openDesk Edu with NixOS";
