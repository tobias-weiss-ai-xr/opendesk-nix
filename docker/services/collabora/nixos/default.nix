...
"""
collabora NixOS Container Image
Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "collabora";
    WorkingDir = "/var/lib/collabora";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service collabora ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "collabora-opendesk";
    "org.opencontainers.image.description" = "collabora latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "collabora";
