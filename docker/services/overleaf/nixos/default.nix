...
# 
# overleaf NixOS Container Image
# Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "overleaf";
    WorkingDir = "/var/lib/overleaf";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service overleaf ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "overleaf-opendesk";
    "org.opencontainers.image.description" = "overleaf latest for openDesk Edu with NixOS";
