...
# 
# nubus-ldap NixOS Container Image
# Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "nubus-ldap";
    WorkingDir = "/var/lib/nubus-ldap";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service nubus-ldap ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "nubus-ldap-opendesk";
    "org.opencontainers.image.description" = "nubus-ldap latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "nubus-ldap";
