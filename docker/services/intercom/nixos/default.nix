...
# 
# intercom NixOS Container Image
# Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "intercom";
    WorkingDir = "/var/lib/intercom";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service intercom ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "intercom-opendesk";
    "org.opencontainers.image.description" = "intercom latest for openDesk Edu with NixOS";
