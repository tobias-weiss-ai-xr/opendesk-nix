...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "snipr";
    WorkingDir = "/var/lib/snipr";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service snipr ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "snipr-opendesk";
    "org.opencontainers.image.description" = "snipr latest for openDesk Edu with NixOS";
