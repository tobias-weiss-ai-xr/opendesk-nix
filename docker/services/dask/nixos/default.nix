...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "dask";
    WorkingDir = "/var/lib/dask";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service dask ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "dask-opendesk";
    "org.opencontainers.image.description" = "dask latest for openDesk Edu with NixOS";
