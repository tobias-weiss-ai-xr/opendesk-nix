...
"""
openproject NixOS Container Image
Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "openproject";
    WorkingDir = "/var/lib/openproject";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service openproject ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "openproject-opendesk";
    "org.opencontainers.image.description" = "openproject latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "openproject";
