...
docks.mkImage {
  ...
  containerConfig = {
    ...
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service sogo ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "sogo-opendesk";
    "org.opencontainers.image.description" = "sogo latest for openDesk Edu with NixOS";
