...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "mariadb";
    WorkingDir = "/var/lib/mariadb";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service mariadb ready" ];
  ...
  ociLabels = {
    ...
    "org.opencontainers.image.description" = "mariadb latest for openDesk Edu with NixOS";
