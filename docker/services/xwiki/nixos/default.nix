...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "xwiki";
    WorkingDir = "/var/lib/xwiki";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service xwiki ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "xwiki-opendesk";
    "org.opencontainers.image.description" = "xwiki latest for openDesk Edu with NixOS";
