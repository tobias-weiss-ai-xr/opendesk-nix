...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "clamav";
    WorkingDir = "/var/lib/clamav";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service clamav ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "clamav-opendesk";
    "org.opencontainers.image.description" = "clamav latest for openDesk Edu with NixOS";
