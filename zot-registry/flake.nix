      ...
      commonArgs = rec {
        ...
        ociLabels = {
          ...
          "org.opencontainers.image.description" =
            "Hardened Zot Registry container image for openDesk Edu. Provides pull-through caching, local registry, multi-registry mirroring, SBOM integration, and signing support.";
        ...
        default = _final: prev: {
          ...
          zot = prev.buildGoModule {
            ...
            ldflags = [
              "-s"
              "-w"
              "-X github.com/project-zot/zot/cmd/zot/cli/AppVersion=${commonArgs.zotVersion}"
            ];
          };
