...
let
  ...
  getSecurityStandard = criticality:
    if criticality == "critical" then
      ...
      opendeskSecurityStandards.high
    else if criticality == "medium" then
      opendeskSecurityStandards.medium
    else if criticality == "low" then
      opendeskSecurityStandards.low
    else
      opendeskSecurityStandards.high;
