...
let
 ...
 name = "portal-entries"; image = "ghcr.io/opendesk-edu/portal-entries"; tag = "latest";
  port = 80;
...
[ (lib.deployment { inherit name image tag port; })
  ...
  (lib.ingressWithCert { inherit name; host = "portal-entries.opendesk.internal"; inherit port; })
]