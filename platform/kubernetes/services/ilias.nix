...
let
  ...
  ociLabels = lib.mkOCILabels {
    inherit name;
    version = tag;
    description = "ilias service for openDesk";
    serviceType = "web";
    component = "backend";
  };
 name = "ilias"; image = "ghcr.io/opendesk-edu/ilias"; tag = "latest";
...
in
 [ (lib.deployment { inherit name image tag; port = 80; })
   ...
   ] ++ (lib.ingressWithCert { inherit name; host = "ilias.opendesk.internal"; port = 80; })