...
let
 ...
 name = "collab-dashboard"; image = "ghcr.io/opendesk-edu/collab-dashboard"; tag = "latest";
  port = 80;
...
] ++ (lib.ingressWithCert { inherit name; host = "collab-dashboard.opendesk.internal"; inherit port; })