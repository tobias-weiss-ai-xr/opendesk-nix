...
let
  ...
  ociLabels = lib.mkOCILabels {
    inherit name;
    version = tag;
    description = "xwiki service for openDesk";
    serviceType = "web";
    component = "backend";
  };
 name = "xwiki"; image = "ghcr.io/opendesk-edu/xwiki"; tag = "latest";
...
] ++ (lib.ingressWithCert { inherit name; host = "xwiki.opendesk.internal"; port = 80; })