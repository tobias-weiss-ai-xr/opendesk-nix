...
let
  ...
  ociLabels = lib.mkOCILabels {
    inherit name;
    version = tag;
    description = "etherpad service for openDesk";
    serviceType = "web";
    component = "backend";
  };
 name = "etherpad"; image = "ghcr.io/opendesk-edu/etherpad"; tag = "1.9.9";
...
] ++ (lib.ingressWithCert { inherit name; host = "etherpad.opendesk.internal"; port = 9001; })