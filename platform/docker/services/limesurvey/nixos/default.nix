...
# 
# limesurvey NixOS Container Image
# Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "limesurvey";
    WorkingDir = "/var/lib/limesurvey";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service limesurvey ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "limesurvey-opendesk";
    "org.opencontainers.image.description" = "limesurvey latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "limesurvey";
