...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "zammad";
    WorkingDir = "/var/lib/zammad";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service zammad ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "zammad-opendesk";
    "org.opencontainers.image.description" = "zammad latest for openDesk Edu with NixOS";
