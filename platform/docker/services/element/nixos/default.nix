...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "element";
    WorkingDir = "/var/lib/element";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service element ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "element-opendesk";
    "org.opencontainers.image.description" = "element latest for openDesk Edu with NixOS";
