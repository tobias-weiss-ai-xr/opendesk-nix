...
docks.mkImage {
  ...
  containerConfig = {
    ...
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service ollama ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "ollama-opendesk";
    "org.opencontainers.image.description" = "ollama latest for openDesk Edu with NixOS";
