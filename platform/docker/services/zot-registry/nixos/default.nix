...
in docks.mkImage {
  ...
  containerConfig = {
    ...
    Volumes = {
      "/var/lib/zot-registry" = { };
      "/var/log/zot-registry" = { };
      "/etc/zot-registry" = { };
    };
    ...
    User = "zot-registry";
    WorkingDir = "/var/lib/zot-registry";

    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service zot-registry ready" ];
  ...
  ociLabels = {
    ...
    "org.opencontainers.image.description" =
      "zot-registry latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "zot-registry";
