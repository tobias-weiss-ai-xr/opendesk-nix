...
# 
# seaweedfs NixOS Container Image
# Version: latest
...
docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "seaweedfs";
    WorkingDir = "/var/lib/seaweedfs";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service seaweedfs ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "seaweedfs-opendesk";
    "org.opencontainers.image.description" = "seaweedfs latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "seaweedfs";
