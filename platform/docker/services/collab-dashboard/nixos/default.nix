...
# 
# collab-dashboard NixOS Container Image
# Version: latest
...
docks.mkImage {
  name = "collab-dashboard-opendesk";
  tag = "latest-nixos";
  ...
  containerConfig = {
    ...
    Volumes = {
      "/var/lib/collab-dashboard" = {};
      "/var/log/collab-dashboard" = {};
      "/etc/collab-dashboard" = {};
    };
    ...
    WorkingDir = "/var/lib/collab-dashboard";
    
    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service collab-dashboard ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "collab-dashboard-opendesk";
    "org.opencontainers.image.description" = "collab-dashboard latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "collab-dashboard";
