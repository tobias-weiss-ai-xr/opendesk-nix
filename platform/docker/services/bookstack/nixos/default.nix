...
# 
# bookstack NixOS Container Image
# Version: latest
...
in docks.mkImage {
  ...
  containerConfig = {
    ...
    User = "bookstack";
    WorkingDir = "/var/lib/bookstack";

    Cmd = [ "/usr/bin/env" "bash" "-c" "echo Service bookstack ready" ];
  ...
  ociLabels = {
    "org.opencontainers.image.title" = "bookstack-opendesk";
    "org.opencontainers.image.description" =
      "bookstack latest for openDesk Edu with NixOS";
    ...
    "com.opendesk.service" = "bookstack";
