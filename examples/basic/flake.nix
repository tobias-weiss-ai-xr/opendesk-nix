    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      in
      {
        packages = {
          ...
          mariadb-deployment = pkgs.writeText "mariadb-deployment.yaml" (builtins.toJSON mariadbDeployment);

          # MariaDB service manifest
          mariadb-service = pkgs.writeText "mariadb-service.yaml" (builtins.toJSON mariadbService);
